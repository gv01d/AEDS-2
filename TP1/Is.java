...
public class Is {
    ...
    static Boolean vowelTest(String test) {

        test += "\n";
        String vow = new String(vowels);

        for (int i = 0; test.charAt(i) != '\n'; i++) {
    ...
    static Boolean consonantTest(String test) {

        test += "\n";
        String con = new String(consonants);
    ...
    static int valueTest(String test) {
