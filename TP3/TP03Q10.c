...
void ins(Personagens *p, Pilha *f)
{
...
void inserir(Personagens *p, Pilha *F)
{
    if (F->length >= 5)
    {
        remover(F);
...
void doOp(char *text, Personagens p[404], Pilha *f)
{
