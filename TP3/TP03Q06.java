...
public class TP03Q06 {
    ...
    static void doOp(String text, Pilha<Personagens> list, Personagens[] arr) throws Exception {
        String op = "";
        int i = 0;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Pilha<Personagens> CharList = new Pilha<Personagens>();
            while (!buff.equals("FIM")) {
                Personagens p = find(buff, hPCharacters);
                if (p != null) {
                    CharList.inserirInicio(p);
                } else {
